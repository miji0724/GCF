...
function ManageLecOffAppDetail() {
    ...
    const sendApprovalRequest = () => {
        axios.put(`/manage/offProgramApproval`, offLecInfo.id, {
            headers: {
    ...
    const sendNotApprovalRequest = () => {
        axios.put(`/manage/offProgramNotApproval`, offLecInfo.id, {
            headers: {
                'Content-Type': 'application/json'
            }
        })
                ...
                <div className='lecOffAppDetail'>
                    ...
                    <div className='lecOffAppDetail_area'>
                        ...
                        <div className='lecOffAppDetail_right'>
                            <ul>
                                <li> <input type='text' id='lecOffAppDetail_lecTitle' value={offLecInfo.programName} readOnly /></li>
                                <li> <input type='text' id='lecOffAppDetail_name' value={offLecInfo.teacher.member.name} readOnly /></li>
                                <li> <input type="text" id='lecOffAppDetail_phoneNum' maxLength="13" value={offLecInfo.teacher.member.phone_number} readOnly /></li>
                                <li> <input type="text" id='lecOffAppDetail_landNum' maxLength="11" value={offLecInfo.teacher.member.tel_number} readOnly /> </li>
                                <li>
                                    <input type='text' id='lecOffAppDetail_emailId' value={offLecInfo.teacher.member.email.split('@')[0]} readOnly />
                                    &nbsp;@&nbsp;
                                    <input type='text' id='lecOffAppDetail_emailAddr' value={offLecInfo.teacher.member.email.split('@')[1]} readOnly />
                                </li>
                                <li><input type='text' id='lecOffAppDetail_poster_attachment' value={offLecInfo.poster.original_name} readOnly /></li>
                                        ...
                                        {offLecInfo.programInfos.map((programInfo, index) => (
                                            <div key={index} className='introduceEdu_flexArea'>
                                                <li>
                                                    <input
                                                        type='text'
                                                        id={`lecOffAppDetail_introduceEdu_detail_${index}`}
                                                ...
                                                <li>
                                                    <input
                                                        ...
                                                        id={`lecOffAppDetail_introduceEdu_attachment_${index}`}
                                                        readOnly
                                                    />
                                                </li>
                                            </div>
                                ...
                                <li>
                                    <select id='lecOffAppDetail_lecField' value={offLecInfo.category} disabled>
                                ...
                                <li className='lecOffAppDetail_program'>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <select id='lecOffAppDetail_dayoftheWeek' value={offLecInfo.dayOfWeek} disabled>
                                        ...
                                        <li> <input type='text' id='lecOffAppDetail_progDetailName' value={offLecInfo.programDetailName} readOnly /></li>
                                    </ul>
                                </li>
                                ...
                                <li>
                                    <div className="lecOffAppDetail_costWrapper" value={offLecInfo.participationFee} >
                                        <input
                                            type='radio'
                                            name='cost'
                                            value='프로그램별상이'
                                ...
                                <li> <textarea className='lecOffAppDetail_contactInfo' value={offLecInfo.application_info} readOnly></textarea></li>
                            </ul>
                        </div>
                    </div>
